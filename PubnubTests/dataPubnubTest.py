...
try:
    while True:
        ...
        if (GPGGA_data_available>0):
            ...
            data = f"lat in degrees: {lat_in_degrees}  long in degree: {long_in_degrees} (x,y,z): ({accelerometer.acceleration[0]},{accelerometer.acceleration[1]},{accelerometer.acceleration[2]})"
